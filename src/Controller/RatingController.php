...
class RatingController extends AbstractController
{
    ...
    /**
     * @Route("/{rateId}", name="rating_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{rateId}/edit", name="rating_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{rateId}", name="rating_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Rating $rating): Response
    {
        if ($this->isCsrfTokenValid('delete'.$rating->getRateId(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
